...
const OFFSET_MASK: u64 = 0xFFFFFFFF;
const CLEAN_VALUE: u64 = 0xFFFFFFFFFFFF;
...
pub fn split_cache_pos(cache_pos: u64) -> (usize, usize, usize) {
    ...
    let idx = ((cache_pos >> OFFSET_BITS) & MASK) as usize;
    let offset = (cache_pos & OFFSET_MASK) as usize;
    (idx, offset, value_len)
}

pub fn clear_cache_pos_value_len(cache_pos: u64) -> u64 {
    cache_pos & CLEAN_VALUE
}
